    ...
    <style>
      ...
      <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
          @if(Auth::user()->role === 3)
          <li class="nav-item"><h4><i class="fa fa-user"></i> {{ Auth::user()->member->username }} </h4></li>
          @endif
          <li class="nav-item">
                      ...
                      <div class="d-flex align-items-center justify-content-between position-relative">
                        <div class="d-flex">
                          ...
                          <div class="flex-1 me-sm-3">
                            <h4 class="fs-9 text-body-emphasis">Admin</h4>
                            <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span class='me-1 fs-10'>💬</span>You receive a raffle ticket!<span class="ms-2 text-body-quaternary text-opacity-75 fw-bold fs-10">10m</span></p>
                              <p class="text-body-secondary fs-9 mb-0"><span class="me-1 fas fa-clock"></span><span class="fw-bold">{{ now()->format('F j, Y') }}</span></p>
                          </div>
                        </div>
              ...
              <div class="card position-relative border-0">
                <div class="card-body p-0">
                  <div class="text-center pt-4 pb-3">
                    ...
                    <h6 class="mt-2 text-body-emphasis" style="text-transform:capitalize">{{ Auth::user()->name }}</h6>
                  </div>
                  <div class="mb-3 mx-3">
                ...
                <div class="overflow-auto scrollbar" style="height: 10rem;">
                  <ul class="nav d-flex flex-column mb-2 pb-1">
                    @if(Auth::user()->role === 3)
                      <li class="nav-item"><a class="nav-link px-3 d-block" href="/member/profile"> <span class="me-2 text-body align-bottom" data-feather="user"></span><span>Profile</span></a></li>
                ...
                <div class="card-footer p-0 border-top border-translucent">
                  ...
                  <hr />
                  <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" id="logout" href="/logout"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
